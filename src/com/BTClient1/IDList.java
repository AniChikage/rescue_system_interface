...
public class IDList extends Activity {
 ...
 //   private Integer intRssi = 0;
  ...
  /*  @Override
	...
	private void Save() {
		//显示对话框输入文件名
		LayoutInflater factory = LayoutInflater.from(IDList.this);  //图层模板生成器句柄
									...
									public void onClick(DialogInterface dialog, int whichButton){
										...
										try{
											if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){  //如果SD卡已准备好
												...
												stream.close();
												Toast.makeText(IDList.this, "存储成功！", Toast.LENGTH_SHORT).show();
											}else{
												Toast.makeText(IDList.this, "没有存储卡！", Toast.LENGTH_LONG).show();
											}
